...
RAYGUIAPI int GuiTextBox(Rectangle bounds, char *text, int textSize, bool editMode, bool passwordMode = false); // Text Box control, updates input text (Durydevelop: added passwordMode)
...
int GuiTextBox(Rectangle bounds, char *text, int bufferSize, bool editMode, bool passwordMode)
{
